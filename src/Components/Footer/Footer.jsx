...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-gradient-to-r from-[#EAD4BB] to-[#CCA78D] text-base-content">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#14261A] text-base-content border-base-300">
